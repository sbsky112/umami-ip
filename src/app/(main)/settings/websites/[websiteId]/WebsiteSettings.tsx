...
import { ImageShareUrl } from '@/components/metrics/ImageShareUrl';
  ...
  return (
    <>
      ...
      <Tabs selectedKey={tab} onSelect={setTab} style={{ marginBottom: 30 }}>
        ...
        <Item key="image">{formatMessage(labels.imageShare)}</Item>
      ...
      {tab === 'image' && <ImageShareUrl websiteId={websiteId} shareId={website?.shareId} />}
